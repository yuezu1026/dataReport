...
| [`doc/技术文章-VAT计税系统.md`](doc/技术文章-VAT计税系统.md) | 📝 技术博客原文：《用 AI 逆向一个 8 年前的 Spring Boot 老项目》 |

> 💡 阅读顺序建议：先看 📝 **技术文章**（整体故事线）→ `代码分析.md`（代码地图）→ `原始需求.md` + `需求文档.md`（需求规格）。
> 🌐 文章同步发布在 CSDN 博客：[《用 AI 逆向一个 8 年前的 Spring Boot 老项目：从裸代码到开源需求文档》](https://blog.csdn.net/)（发布后更新链接）
...
- CSDN 博客: [技术文章专栏](https://blog.csdn.net/)（《用 AI 逆向 8 年前的 Spring Boot 老项目》等）
