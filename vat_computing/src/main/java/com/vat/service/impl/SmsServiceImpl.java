...
public class SmsServiceImpl implements SmsService{
    ...
    private static final String accessKeyId = "LTAINr8gApbGqTIs";
    private static final String accessKeySecret = "jX0vqLMJm2VCVhKozMaBw16hvJHmVp";

    @Override
    public SendSmsResponse sendSms(SmsVO smsVO) throws ClientException {
	
	if(smsVO == null) {
	    logger.info("send sms is empty.");
	    return null;
	}
        ...
        //"{\"name\":\"Tom\", \"code\":\"123\"}"
        request.setTemplateParam(smsVO.getTemplateParam());
    ...
    @Override
    public QuerySendDetailsResponse querySendDetails(String bizId,String phoneNunber) throws ClientException {
        ...
        //必填-号码
        request.setPhoneNumber(phoneNunber);
        //可选-流水号
