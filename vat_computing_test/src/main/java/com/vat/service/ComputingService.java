...
public interface ComputingService {
    ...
    void computing(String userId, String[] periodList, String needComputingCountry);

    void computingByPeriod(String userId, String activityPeriod, String needComputingCountry);

    void computingResultByPeriod(String userId, String period, String needComputingCountry);
