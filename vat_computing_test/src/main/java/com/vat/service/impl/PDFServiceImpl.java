...
public class PDFServiceImpl implements PDFService {
    ...
    private static final String platform = "****信息服务中心";
	...
	pdfutil.imageWaterMark(pdfutil.createPDF(fontPath, outPath), "D://hand.png");
    }
	...
	p1 = new Paragraph("2.更多咨询，请致电客户服务热线********。", textFont);
	doc.add(p1);
